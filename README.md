...
| `signingCosmWasmClientOptions` | `SigningCosmWasmClientOptions \| undefined` |          | Options passed to SigningCosmWasmClient on connection.                                                                                               |
| `signingStargateClientOptions` | `SigningStargateClientOptions \| undefined` |          | Options passed to SigningStargateClient on connection.                                                                                               |
...
| `signingCosmWasmClientOptions` | `SigningCosmWasmClientOptions \| undefined` |                                                                                                                                                                                                           | Options passed to SigningCosmWasmClient on connection. This is passed through from the provider props to allow composition of your own hooks, and for use in the built-in useWallet hook. |
| `signingStargateClientOptions` | `SigningStargateClientOptions \| undefined` |                                                                                                                                                                                                           | Options passed to SigningStargateClient on connection. This is passed through from the provider props to allow composition of your own hooks, and for use in the built-in useWallet hook. |
