...
```sh
npm install --save @noahsaso/cosmodal @cosmjs/cosmwasm-stargate @cosmjs/encoding @cosmjs/proto-signing @cosmjs/stargate
# OR
yarn add @noahsaso/cosmodal @cosmjs/cosmwasm-stargate @cosmjs/encoding @cosmjs/proto-signing @cosmjs/stargate
```
