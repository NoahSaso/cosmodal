...
const SimpleChainInfoList: Record<ChainInfoID, SimplifiedChainInfo> = {
  ...
  [ChainInfoID.ChronicNetwork1]: {
    ...
    bech32Config: Bech32Address.defaultBech32Config("chronic"),
    currencies: [
      {
        coinDenom: "CHT",
        coinMinimalDenom: "ucht",
        coinDecimals: 6,
        coinGeckoId: "chronic-token",
        coinImageUrl: "/tokens/cht.svg",
        isStakeCurrency: true,
        isFeeCurrency: false,
      },
      {
        ...
        coinDecimals: 6,
        coinGeckoId: "chronic-gas",
        coinImageUrl: "/tokens/cgas.svg",
